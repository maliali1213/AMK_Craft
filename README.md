...
<section>
  <h2>رنک می‌خوای؟</h2>
  <div class="rank">🎖 بهترین رنک: <strong>AMK Man</strong></div>
  ...
  <h2>مدیرهای سرور</h2>
  <p>itss_arya<br />94_AMK</p> />maliali1213</p>

  <h2>🛒 خرید داری؟</h2>
  <p>برای خرید داخل روبیکا به آیدی‌های زیر پیام بده ✅</p>
  <p>
    <a href="https://rubika.ir/@maliali1213_player" target="_blank">@maliali1213_player</a><br />
    <a href="https://rubika.ir/@MASTERAMK" target="_blank">@MASTERAMK</a>
  </p>
</section>
...
<section id="about" style="margin-top:40px; padding: 0 20px; max-width: 600px; margin-left:auto; margin-right:auto; text-align: justify;">
  ...
  <p>
    ...
    با مدیریت  <strong>94_AMK</strong> و <strong>maliali1213/strong> اداره میشه.  
    این سرور قابلیت‌های بزرگی مثل رنک، اقتصاد، رویداد و غیره داره.  
    این سایت هم توسط تیم <strong>TheMamali</strong> طراحی و تولید شده است.
  </p>
</section>
...
<div id="registerFormContainer">
  <h2></h2>ثبت نام در ای ام کی کرفت</h2>
